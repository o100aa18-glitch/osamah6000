...
const electricityServices: ServiceItem[] = [
  // الأعمال الصغرى
  { id: "e1", category: "الكهرباء", name: "تغيير لمبة شمعة أو حباب داخل ثريا أو أبليك", price: "5 - 10 ريال", image: getImageUrl("electricity-01-bulb-candle") },
  { id: "e2", category: "الكهرباء", name: "تركيب غطاء فيش أو جلبة حماية للأطفال", price: "5 - 10 ريال", image: getImageUrl("electricity-02-socket-cover") },
  { id: "e3", category: "الكهرباء", name: "تغيير فيوز فيش جداري أو وصلة", price: "10 - 20 ريال", image: getImageUrl("electricity-03-fuse") },
  { id: "e4", category: "الكهرباء", name: "توصيل أو تغيير روزتة أو كلبس تجميع", price: "10 - 20 ريال", image: getImageUrl("electricity-04-connector") },
  { id: "e5", category: "الكهرباء", name: "توصيل سلك شاشة أو دش بالفيش", price: "15 - 25 ريال", image: getImageUrl("electricity-05-coaxial-cable") },
  { id: "e6", category: "الكهرباء", name: "تثبيت حوامل سلكية أو كلبسات جدارية", price: "20 - 40 ريال", image: getImageUrl("electricity-06-cable-clips") },
  { id: "e7", category: "الكهرباء", name: "تركيب جلبة تمديد بلاستيك أو ألمنيوم للمتر", price: "10 - 15 ريال", image: getImageUrl("electricity-07-casing-tube") },
  { id: "e8", category: "الكهرباء", name: "تركيب محول ترانس لإضاءة الليد", price: "20 - 35 ريال", image: getImageUrl("electricity-08-transformer") },
  { id: "e9", category: "الكهرباء", name: "تركيب وتثبيت حساس ضوئي لإضاءة السور", price: "40 - 70 ريال", image: getImageUrl("electricity-09-photocell") },
  // الصيانة والأعطال
  { id: "e10", category: "الكهرباء", name: "كشف الالتماس وتتبع الأعطال مع الأجهزة", price: "150 - 250 ريال", image: getImageUrl("electricity-10-circuit-breaker") },
  { id: "e11", category: "الكهرباء", name: "إصلاح شورت الكهرباء وهبوط الفولت", price: "120 - 200 ريال", image: getImageUrl("electricity-10-circuit-breaker") },
  { id: "e12", category: "الكهرباء", name: "تغيير قاطع فرعي", price: "30 - 50 ريال", image: getImageUrl("electricity-10-circuit-breaker") },
  { id: "e13", category: "الكهرباء", name: "تغيير قاطع رئيسي مجمع", price: "100 - 150 ريال", image: getImageUrl("electricity-30-main-breaker-box") },
  { id: "e14", category: "الكهرباء", name: "إصلاح خط تكييف محروق أو مفصول", price: "100 - 180 ريال", image: getImageUrl("electricity-36-split-ac-wiring") },
  { id: "e15", category: "الكهرباء", name: "ترتيب وتوزيع أحمال الطبلون", price: "150 - 300 ريال", image: getImageUrl("electricity-27-panel-assembly") },
  { id: "e16", category: "الكهرباء", name: "إعادة تأريض وإصلاح الأرضي", price: "150 - 250 ريال", image: getImageUrl("electricity-29-grounding-rod") },
  // الإضاءة والديكورات
  { id: "e17", category: "الكهرباء", name: "تركيب سبوت لايت أو داون لايت بفتحة جاهزة", price: "10 - 15 ريال", image: getImageUrl("electricity-11-spotlight") },
  { id: "e18", category: "الكهرباء", name: "قص فتحة جص وتركيب سبوت لايت", price: "20 - 30 ريال", image: getImageUrl("electricity-11-spotlight") },
  { id: "e19", category: "الكهرباء", name: "تركيب شريط إضاءة مخفية ليد للمتر", price: "10 - 15 ريال", image: getImageUrl("electricity-12-led-strip") },
  { id: "e20", category: "الكهرباء", name: "تركيب ليد بروفايل بالمتر", price: "25 - 45 ريال", image: getImageUrl("electricity-13-led-profile") },
  { id: "e21", category: "الكهرباء", name: "تركيب أبليك جداري داخلي أو خارجي", price: "25 - 40 ريال", image: getImageUrl("electricity-14-wall-lamp") },
  { id: "e22", category: "الكهرباء", name: "تركيب نجفة صغيرة أو معلقة", price: "50 - 80 ريال", image: getImageUrl("electricity-15-pendant-light") },
  { id: "e23", category: "الكهرباء", name: "تركيب ثريا كبيرة متعددة الأدوار", price: "150 - 350 ريال", image: getImageUrl("electricity-16-chandelier") },
  { id: "e24", category: "الكهرباء", name: "تركيب مرايا مضيئة", price: "50 - 90 ريال", image: getImageUrl("electricity-17-mirror-light") },
  { id: "e25", category: "الكهرباء", name: "تركيب إضاءة حدائق وكشافات", price: "30 - 60 ريال", image: getImageUrl("electricity-18-garden-lights") },
  // المفاتيح والأنظمة الذكية
  { id: "e26", category: "الكهرباء", name: "تركيب مفتاح أو فيش عادي", price: "15 - 20 ريال", image: getImageUrl("electricity-19-smart-switch") },
  { id: "e27", category: "الكهرباء", name: "تركيب مفتاح ذكي أو ديمر تعتيم", price: "25 - 50 ريال", image: getImageUrl("electricity-19-smart-switch") },
  { id: "e28", category: "الكهرباء", name: "تركيب مفتاح دركسون ثلاثي الاتجاهات", price: "30 - 50 ريال", image: getImageUrl("electricity-20-3way-switch") },
  { id: "e29", category: "الكهرباء", name: "تركيب تايمر ميكانيكي أو إلكتروني", price: "80 - 150 ريال", image: getImageUrl("electricity-21-timer") },
  // التأسيس والأجهزة المساندة
  { id: "e30", category: "الكهرباء", name: "تركيب جرس عادي أو جرس كاميرا ذكي", price: "40 - 100 ريال", image: getImageUrl("electricity-22-doorbell") },
  { id: "e31", category: "الكهرباء", name: "تركيب مروحة شفط جدارية أو سقفية", price: "40 - 80 ريال", image: getImageUrl("electricity-23-exhaust-fan") },
  { id: "e32", category: "الكهرباء", name: "تركيب مروحة سقف", price: "60 - 100 ريال", image: getImageUrl("electricity-24-ceiling-fan") },
  { id: "e33", category: "الكهرباء", name: "تأسيس نقطة كهرباء علبة ومواسير وسحب سلك", price: "35 - 50 ريال", image: getImageUrl("electricity-25-electrical-box") },
  { id: "e34", category: "الكهرباء", name: "سحب كابل رئيسي من الطبلون للغرفة", price: "80 - 200 ريال", image: getImageUrl("electricity-26-cable-run") },
  { id: "e35", category: "الكهرباء", name: "تجميع وترتيب طبلون كهرباء جديد", price: "250 - 500 ريال", image: getImageUrl("electricity-27-panel-assembly") },
  { id: "e36", category: "الكهرباء", name: "تأسيس وتمديد خطوط السبليت كهرباء", price: "100 - 180 ريال", image: getImageUrl("electricity-36-split-ac-wiring") },
  { id: "e37", category: "الكهرباء", name: "تمديد الخطوط الرئيسية", price: "150 - 300 ريال", image: getImageUrl("electricity-37-main-cable") },
];

// جميع خدمات السباكة - 42 خدمة
const plumbingServices: ServiceItem[] = [
  // الأعمال الصغرى
  { id: "p1", category: "السباكة", name: "وضع تفلون ومعجون على الوصلات وتثبيتها", price: "10 - 20 ريال", image: getImageUrl("plumbing-01-teflon-tape") },
  { id: "p2", category: "السباكة", name: "تغيير جلبة أو وجه خلاط", price: "15 - 25 ريال", image: getImageUrl("plumbing-02-faucet-gasket") },
  { id: "p3", category: "السباكة", name: "تنظيف وإزالة الكلس من فلاتر المغاسل", price: "15 - 25 ريال", image: getImageUrl("plumbing-03-filter-cleaning") },
  { id: "p4", category: "السباكة", name: "تركيب غطاء صفاية ستانلس أو سدادة ريحة", price: "15 - 25 ريال", image: getImageUrl("plumbing-04-sink-strainer") },
  { id: "p5", category: "السباكة", name: "تغيير ليات مغسلة أو كرسي أو تسخين", price: "20 - 35 ريال", image: getImageUrl("plumbing-05-faucet-core") },
  { id: "p6", category: "السباكة", name: "تركيب أو تغيير قلب الشطاف", price: "20 - 30 ريال", image: getImageUrl("plumbing-06-shower-head") },
  { id: "p7", category: "السباكة", name: "تغيير رأس الدش سماعة الدش", price: "20 - 30 ريال", image: getImageUrl("plumbing-07-drain-gasket") },
  { id: "p8", category: "السباكة", name: "تغيير جلبة الصرف التلسكوبية الجرجوري", price: "25 - 40 ريال", image: getImageUrl("plumbing-08-odor-trap") },
  { id: "p9", category: "السباكة", name: "تركيب رداد منع الرائحة أو الرجوع", price: "30 - 50 ريال", image: getImageUrl("plumbing-09-angle-valve") },
  { id: "p10", category: "السباكة", name: "تثبيت حلقة سيليكون لمنع تسريب الكرسي", price: "40 - 60 ريال", image: getImageUrl("plumbing-10-kitchen-faucet") },
  // الصيانة والتسريبات
  { id: "p11", category: "السباكة", name: "كشف تسربات بالمعاينة والفحص", price: "100 - 150 ريال", image: getImageUrl("plumbing-29-leak-detection") },
  { id: "p12", category: "السباكة", name: "تغيير قلب حنفية أو خلاط أو سيفون", price: "40 - 70 ريال", image: getImageUrl("plumbing-02-faucet-gasket") },
  { id: "p13", category: "السباكة", name: "إصلاح تسريب تحت الحوض أو المغسلة", price: "80 - 120 ريال", image: getImageUrl("plumbing-34-faucet-leak") },
  { id: "p14", category: "السباكة", name: "إصلاح ماكينة سيفون دفن أو عادي", price: "80 - 150 ريال", image: getImageUrl("plumbing-32-siphon-repair") },
  { id: "p15", category: "السباكة", name: "معالجة تسريب كرسي عربي أو فرنجي", price: "100 - 180 ريال", image: getImageUrl("plumbing-33-toilet-repair") },
  { id: "p16", category: "السباكة", name: "تسليك انسداد مجاري داخلي صفاية أو حوض", price: "100 - 250 ريال", image: getImageUrl("plumbing-30-drain-cleaning") },
  { id: "p17", category: "السباكة", name: "تسليك خط مجاري رئيسي بالسستة", price: "200 - 400 ريال", image: getImageUrl("plumbing-31-main-drain") },
  // الأدوات الصحية والتشطيبات
  { id: "p18", category: "السباكة", name: "تركيب شطاف أو محبس زاوية", price: "20 - 40 ريال", image: getImageUrl("plumbing-09-angle-valve") },
  { id: "p19", category: "السباكة", name: "تركيب خلاط دش أو مغسلة أو مجلى", price: "50 - 80 ريال", image: getImageUrl("plumbing-06-shower-head") },
  { id: "p20", category: "السباكة", name: "تركيب خلاط مخفي دفن", price: "120 - 220 ريال", image: getImageUrl("plumbing-11-hidden-faucet") },
  { id: "p21", category: "السباكة", name: "تركيب كرسي فرنجي عادي", price: "120 - 180 ريال", image: getImageUrl("plumbing-12-toilet-seat") },
  { id: "p22", category: "السباكة", name: "تركيب مغسلة ديكور رخام أو معلقة", price: "120 - 250 ريال", image: getImageUrl("plumbing-13-marble-sink") },
  { id: "p23", category: "السباكة", name: "تركيب كرسي فرنجي معلق مع الصندوق", price: "250 - 450 ريال", image: getImageUrl("plumbing-14-hanging-toilet") },
  { id: "p24", category: "السباكة", name: "تركيب شاور بكس أو كابينة دش", price: "200 - 400 ريال", image: getImageUrl("plumbing-15-shower-cabin") },
  { id: "p25", category: "السباكة", name: "تركيب جاكوزي أو بانيو عادي", price: "250 - 500 ريال", image: getImageUrl("plumbing-16-jacuzzi") },
  // السخانات والأجهزة المنزلية
  { id: "p26", category: "السباكة", name: "توصيل غسالة ملابس أو صحون", price: "60 - 100 ريال", image: getImageUrl("plumbing-17-washing-machine") },
  { id: "p27", category: "السباكة", name: "تغيير شمعة سخان أو هيتر", price: "70 - 120 ريال", image: getImageUrl("plumbing-18-heater-element") },
  { id: "p28", category: "السباكة", name: "تركيب سخان مياه عادي من 40 إلى 80 ليتر", price: "80 - 130 ريال", image: getImageUrl("plumbing-19-water-heater") },
  { id: "p29", category: "السباكة", name: "تركيب سخان مخفي أو أفقي أو مركزي صغير", price: "150 - 280 ريال", image: getImageUrl("plumbing-20-hidden-heater") },
  // المضخات والخزانات والتأسيس
  { id: "p30", category: "السباكة", name: "تغيير طقم مراحل فلتر المياه", price: "50 - 80 ريال", image: getImageUrl("plumbing-21-filter-cartridge") },
  { id: "p31", category: "السباكة", name: "تركيب فلتر مياه منزلي من 5 إلى 7 مراحل", price: "100 - 150 ريال", image: getImageUrl("plumbing-22-water-filter") },
  { id: "p32", category: "السباكة", name: "تركيب جهاز فلوماك أو أوتوماتيك مضخة", price: "80 - 120 ريال", image: getImageUrl("plumbing-23-flowmeter") },
  { id: "p33", category: "السباكة", name: "تركيب مضخة مياه دينامو مع الأوتوماتيك", price: "150 - 250 ريال", image: getImageUrl("plumbing-24-water-pump") },
  { id: "p34", category: "السباكة", name: "تركيب فلتر مركزي جامبو للخزان", price: "150 - 250 ريال", image: getImageUrl("plumbing-25-central-filter") },
  { id: "p35", category: "السباكة", name: "تركيب أو تحديث شبكة خزان علوي", price: "300 - 600 ريال", image: getImageUrl("plumbing-26-tank-setup") },
  { id: "p36", category: "السباكة", name: "تأسيس مطبخ كامل تغذية وصرف", price: "500 - 900 ريال", image: getImageUrl("plumbing-27-kitchen-installation") },
  { id: "p37", category: "السباكة", name: "تأسيس حمام كامل تغذية وصرف", price: "800 - 1500 ريال", image: getImageUrl("plumbing-28-bathroom-installation") },
];
...
const cameraServices: ServiceItem[] = [
  ...
  { id: "cam6", category: "الكاميرات", name: "تركيب قفل باب ذكي", price: "300 ريال", image: getImageUrl("camera-06-smart-lock") },
  { id: "cam7", category: "الكاميرات", name: "تركيب انتركوم منزلي", price: "250 ريال", image: getImageUrl("camera-07-intercom") },
];

// خدمات الديكور والتركيبات
const decorServices: ServiceItem[] = [
  { id: "dec1", category: "الديكور", name: "تركيب لوحات جدارية صغيرة أو متوسطة", price: "15 - 30 ريال", image: getImageUrl("decor-01-wall-art") },
  { id: "dec2", category: "الديكور", name: "تركيب أرفف خشبية", price: "30 - 60 ريال", image: getImageUrl("decor-02-wall-shelf") },
  { id: "dec3", category: "الديكور", name: "تركيب حامل شاشة جداري", price: "50 - 100 ريال", image: getImageUrl("decor-03-tv-mount") },
  { id: "dec4", category: "الديكور", name: "تركيب ستائر رول", price: "40 - 70 ريال", image: getImageUrl("decor-04-curtains") },
  { id: "dec5", category: "الديكور", name: "تركيب مرايا جدارية", price: "40 - 80 ريال", image: getImageUrl("decor-05-mirror") },
  { id: "dec6", category: "الديكور", name: "تركيب ساعات جدارية ديكورية", price: "20 - 40 ريال", image: getImageUrl("decor-06-wall-clock") },
  { id: "dec7", category: "الديكور", name: "تركيب تعليقات وديكورات جدارية", price: "30 - 70 ريال", image: getImageUrl("decor-07-hanging-decor") },
  { id: "dec8", category: "الديكور", name: "تركيب وتثبيت عام", price: "25 - 45 ريال", image: getImageUrl("decor-08-wall-mounting") },
];
