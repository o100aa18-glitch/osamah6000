...
const plumbingServices: ServiceItem[] = [
  ...
  { id: "p7", category: "السباكة", name: "تغيير رأس الدش سماعة الدش", price: "20 - 30 ريال", image: getImageUrl("plumbing-06-shower-head") },
  { id: "p8", category: "السباكة", name: "تغيير جلبة الصرف التلسكوبية الجرجوري", price: "25 - 40 ريال", image: getImageUrl("plumbing-07-drain-gasket") },
  { id: "p9", category: "السباكة", name: "تركيب رداد منع الرائحة أو الرجوع", price: "30 - 50 ريال", image: getImageUrl("plumbing-08-odor-trap") },
  { id: "p10", category: "السباكة", name: "تثبيت حلقة سيليكون لمنع تسريب الكرسي", price: "40 - 60 ريال", image: getImageUrl("plumbing-12-toilet-seat") },
  // الصيانة والتسريبات
