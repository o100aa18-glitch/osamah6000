...
const SocialIcons = {
  ...
  tiktok: (
    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
      <path d="M12.525.02C7.1.02 2.75 4.35 2.75 9.85c0 5.5 4.35 9.83 9.75 9.83 5.4 0 9.75-4.35 9.75-9.83 0-5.5-4.35-9.83-9.75-9.83zM9.96 17.325c-1.77 0-3.29-1.02-4.51-2.55.5 1.63 2.02 2.96 3.69 2.96 1.71 0 3.21-1.33 3.72-2.96-1.35 1.63-2.89 2.55-4.9 2.55zm.01-5.38c-1.77 0-3.29-1.23-3.29-2.74s1.52-2.74 3.29-2.74c1.77 0 3.29 1.23 3.29 2.74s-1.52 2.74-3.29 2.74zm5.38 5.38c-1.63 0-3.06-1.02-3.56-2.55.5 1.63 2.02 2.96 3.69 2.96 1.71 0 3.21-1.33 3.72-2.96-1.35 1.63-2.89 2.55-4.85 2.55zm.01-5.38c-1.77 0-3.29-1.23-3.29-2.74s1.52-2.74 3.29-2.74c1.77 0 3.29 1.23 3.29 2.74s-1.52 2.74-3.29 2.74z"/>
    </svg>
  ),
  instagram: (
    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
  ...
  snapchat: (
    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 0C5.383 0 0 5.383 0 12s5.383 12 12 12 12-5.383 12-12S18.617 0 12 0zm0 22.5C6.201 22.5 1.5 17.799 1.5 12S6.201 1.5 12 1.5 22.5 6.201 22.5 12 17.799 22.5 12 22.5zm3.75-9.75c.621 0 1.125-.504 1.125-1.125s-.504-1.125-1.125-1.125-1.125.504-1.125 1.125.504 1.125 1.125 1.125zm-7.5 0c.621 0 1.125-.504 1.125-1.125s-.504-1.125-1.125-1.125-1.125.504-1.125 1.125.504 1.125 1.125 1.125zm3.75 6.75c-2.484 0-4.688-1.406-5.859-3.469h11.719c-1.172 2.063-3.375 3.469-5.859 3.469z"/>
    </svg>
  ),
  x: (
    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
  ...
  whatsapp: (
    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
      <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.67-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.076 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421-7.403h-.004a6.963 6.963 0 00-3.429.942l-.246.142-2.552.666.679-2.476.135-.214a6.961 6.961 0 1010.118 3.861v-.001c-.001-.023 0-.046 0-.069a6.963 6.963 0 00-3.501-2.25m5.031 15.901l-3.143-1.271c-.356-.182-.921-.142-1.285-.338-.475-.258-.99-.641-1.544-.571-.692.084-1.618.18-2.131-.424-.463-.547-.745-1.431-.745-2.29 0-2.449 1.893-4.788 4.38-4.788 2.487 0 4.38 2.339 4.38 4.788 0 .86-.282 1.744-.745 2.291-.513.604-1.439.508-2.131.424-.554-.07-1.069.313-1.544.571-.364.196-.929.156-1.285.338l-3.143 1.271c-.356.182-.747.481-.747.481s.391-.299.747-.481z"/>
    </svg>
  ),
};
