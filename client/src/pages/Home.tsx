...
const acServices: ServiceItem[] = [
  { id: "ac1", category: "التكييف", name: "غسيل مكيف سبليت", price: "120 ريال", image: getImageUrl("ac-03-ac-cleaning_f01a6023") },
  { id: "ac2", category: "التكييف", name: "تعبئة فريون كامل", price: "250 ريال", image: getImageUrl("ac-04-refrigerant_ece9b064") },
  { id: "ac3", category: "التكييف", name: "تركيب مكيف سبليت", price: "350 ريال", image: getImageUrl("ac-01-split-unit_ed3c8716") },
  { id: "ac4", category: "التكييف", name: "صيانة مكيف شباك", price: "80 ريال", image: getImageUrl("ac-02-window-ac_cf816a2b") },
  { id: "ac5", category: "التكييف", name: "تعبئة فريون تكميلي", price: "150 ريال", image: getImageUrl("ac-05-ac-installation_e2b1f205") },
];

// خدمات الكاميرات والأنظمة
const cameraServices: ServiceItem[] = [
  { id: "cam1", category: "الكاميرات", name: "تركيب كاميرة مراقبة داخلية أو خارجية", price: "40 - 70 ريال", image: getImageUrl("camera-01-cctv_2025efe5") },
  { id: "cam2", category: "الكاميرات", name: "تركيب كاميرة مراقبة متحركة PTZ", price: "80 - 150 ريال", image: getImageUrl("camera-02-ptz-camera_75e727b3") },
  { id: "cam3", category: "الكاميرات", name: "تركيب كاميرة شحن لاسلكية أو طاقة شمسية", price: "60 - 100 ريال", image: getImageUrl("camera-03-wireless-camera_743acc53") },
  { id: "cam4", category: "الكاميرات", name: "تركيب جرس باب ذكي مزود بكاميرة", price: "50 - 90 ريال", image: getImageUrl("camera-04-smart-doorbell_3c0d6aac") },
  { id: "cam5", category: "الكاميرات", name: "تركيب وعرض كاميرات على الشاشة", price: "80 - 150 ريال", image: getImageUrl("camera-05-dvr-system_ad6ed3e3") },
