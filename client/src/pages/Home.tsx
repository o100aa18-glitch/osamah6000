...
const SocialIcons = {
  ...
  snapchat: (
    <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 0C5.383 0 0 5.383 0 12c0 3.315 1.465 6.285 3.78 8.355.09.12.15.27.15.42v3.825c0 .6.66 1.005 1.2.675l3.465-2.31c.615.135 1.26.235 1.905.235 6.617 0 12-5.383 12-12S18.617 0 12 0zm1.5 15.75h-3v3h3v-3zm0-4.5h-3v3h3v-3z"/>
    </svg>
  ),
  x: (
    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
